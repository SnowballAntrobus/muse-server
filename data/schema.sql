...
GRANT USAGE ON SCHEMA app_hidden TO musedb_visitor;
...
GRANT USAGE ON SCHEMA app_public TO musedb_visitor;
...
GRANT ALL ON SCHEMA public TO musedb;
GRANT USAGE ON SCHEMA public TO musedb_visitor;
...
GRANT SELECT ON TABLE app_public.users TO musedb_visitor;
...
GRANT UPDATE(username) ON TABLE app_public.users TO musedb_visitor;
...
GRANT UPDATE(name) ON TABLE app_public.users TO musedb_visitor;
...
GRANT UPDATE(avatar_url) ON TABLE app_public.users TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.accept_invitation_to_organization(invitation_id uuid, code text) TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.change_password(old_password text, new_password text) TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.confirm_account_deletion(token text) TO musedb_visitor;
...
GRANT SELECT ON TABLE app_public.organizations TO musedb_visitor;
...
GRANT UPDATE(slug) ON TABLE app_public.organizations TO musedb_visitor;
...
GRANT UPDATE(name) ON TABLE app_public.organizations TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.create_organization(slug public.citext, name text) TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.current_session_id() TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public."current_user"() TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.current_user_id() TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.current_user_invited_organization_ids() TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.current_user_member_organization_ids() TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.delete_organization(organization_id uuid) TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.forgot_password(email public.citext) TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.invite_to_organization(organization_id uuid, username public.citext, email public.citext) TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.logout() TO musedb_visitor;
...
GRANT SELECT,DELETE ON TABLE app_public.user_emails TO musedb_visitor;
...
GRANT INSERT(email) ON TABLE app_public.user_emails TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.make_email_primary(email_id uuid) TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.organization_for_invitation(invitation_id uuid, code text) TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.organizations_current_user_is_billing_contact(org app_public.organizations) TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.organizations_current_user_is_owner(org app_public.organizations) TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.remove_from_organization(organization_id uuid, user_id uuid) TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.request_account_deletion() TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.resend_email_verification_code(email_id uuid) TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.tg__graphql_subscription() TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.tg_user_emails__forbid_if_verified() TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.tg_user_emails__prevent_delete_last_email() TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.tg_user_emails__verify_account_on_verified() TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.tg_users__deletion_organization_checks_and_actions() TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.transfer_organization_billing_contact(organization_id uuid, user_id uuid) TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.transfer_organization_ownership(organization_id uuid, user_id uuid) TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.users_has_password(u app_public.users) TO musedb_visitor;
...
GRANT ALL ON FUNCTION app_public.verify_email(user_email_id uuid, token text) TO musedb_visitor;
...
GRANT SELECT ON TABLE app_public.organization_memberships TO musedb_visitor;
...
GRANT SELECT,DELETE ON TABLE app_public.user_authentications TO musedb_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE musedb IN SCHEMA app_hidden GRANT SELECT,USAGE ON SEQUENCES  TO musedb_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE musedb IN SCHEMA app_hidden GRANT ALL ON FUNCTIONS  TO musedb_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE musedb IN SCHEMA app_public GRANT SELECT,USAGE ON SEQUENCES  TO musedb_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE musedb IN SCHEMA app_public GRANT ALL ON FUNCTIONS  TO musedb_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE musedb IN SCHEMA public GRANT SELECT,USAGE ON SEQUENCES  TO musedb_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE musedb IN SCHEMA public GRANT ALL ON FUNCTIONS  TO musedb_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE musedb REVOKE ALL ON FUNCTIONS  FROM PUBLIC;
